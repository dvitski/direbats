package cc.dvitski.direbats.data

import cc.dvitski.direbats.data.server.DirebatsAdvancementProvider
import cc.dvitski.direbats.data.server.DirebatsEntityLootTableProvider
import cc.dvitski.direbats.data.server.DirebatsLanguageProvider
import cc.dvitski.direbats.data.server.DirebatsRecipeProvider
import cc.dvitski.direbats.data.server.tag.DirebatsBiomeTagProvider
import cc.dvitski.direbats.data.server.tag.DirebatsEntityTypeTagProvider
import cc.dvitski.direbats.data.server.tag.DirebatsGameEventTagProvider
import cc.dvitski.direbats.data.server.tag.DirebatsItemTagProvider
...
object DirebatsDataGeneration : DataGeneratorEntrypoint {
    override fun onInitializeDataGenerator(generator: FabricDataGenerator) {
        ...
        if (FabricLoader.getInstance().environmentType === EnvType.CLIENT) {
            try {
                val clientEntrypointClass = Class.forName("cc.dvitski.direbats.client.data.DirebatsClientDataGeneration")
